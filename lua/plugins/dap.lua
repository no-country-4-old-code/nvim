...
return {
	{
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>dn", dap.step_over, { desc = "Step over (debug)" })
			vim.keymap.set("n", "<leader>ds", dap.step_into, { desc = "Step into (debug)" })
			vim.keymap.set("n", "<leader>do", dap.step_out, { desc = "Step out (debug)" })
